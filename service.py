...
def get_temperature_by_city(city_name: str, api_key: str, state_code: str = '', country_code: str = '',
                            limit: int = 1) -> float:
    try:
...
def is_temperature_anomal(temperature: float, season: str, city_weather_data: CityWeatherData) -> bool:
